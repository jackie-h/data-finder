...
class StringAttribute(Attribute):
    ...
    def eq(self, value: str) -> Operation:
        return ComparisonOperation(self,ComparisonOperator.EQUAL, StringConstantOperation(value))
...
class DoubleAttribute(NumericAttribute):
    ...
    def eq(self, value: float) -> Operation:
        return ComparisonOperation(self,ComparisonOperator.EQUAL, FloatConstantOperation(value))

    def __eq__(self, value: float) -> Operation:
        return ComparisonOperation(self,ComparisonOperator.EQUAL, FloatConstantOperation(value))

    def __gt__(self, value: float) -> Operation:
        return ComparisonOperation(self,ComparisonOperator.GREATER_THAN, FloatConstantOperation(value))

    def __lt__(self, value: float):
        return ComparisonOperation(self,ComparisonOperator.LESS_THAN, FloatConstantOperation(value))

    def __ge__(self, value: float) -> Operation:
        return ComparisonOperation(self,ComparisonOperator.GREATER_THAN_OR_EQUAL_TO, FloatConstantOperation(value))

    def __le__(self, value: float):
        return ComparisonOperation(self,ComparisonOperator.LESS_THAN_OR_EQUAL_TO, FloatConstantOperation(value))
...
class DecimalAttribute(NumericAttribute):
    ...
    def eq(self, value: decimal.Decimal) -> Operation:
        return ComparisonOperation(self,ComparisonOperator.EQUAL, DecimalConstantOperation(value))

    def __eq__(self, value: decimal.Decimal) -> Operation:
        return ComparisonOperation(self,ComparisonOperator.EQUAL, DecimalConstantOperation(value))

    def __gt__(self, value: decimal.Decimal) -> Operation:
        return ComparisonOperation(self,ComparisonOperator.GREATER_THAN, DecimalConstantOperation(value))

    def __lt__(self, value: decimal.Decimal) -> Operation:
        return ComparisonOperation(self,ComparisonOperator.LESS_THAN, DecimalConstantOperation(value))

    def __ge__(self, value: decimal.Decimal) -> Operation:
        return ComparisonOperation(self,ComparisonOperator.GREATER_THAN_OR_EQUAL_TO, DecimalConstantOperation(value))

    def __le__(self, value: decimal.Decimal) -> Operation:
        return ComparisonOperation(self,ComparisonOperator.LESS_THAN_OR_EQUAL_TO, DecimalConstantOperation(value))
...
class BooleanAttribute(Attribute):
    ...
    def eq(self, value: bool) -> Operation:
        return ComparisonOperation(self,ComparisonOperator.EQUAL, BooleanConstantOperation(value))

    def __eq__(self, value: bool) -> Operation:
        return ComparisonOperation(self,ComparisonOperator.EQUAL, BooleanConstantOperation(value))

    def is_true(self) -> Operation:
        return ComparisonOperation(self,ComparisonOperator.EQUAL, BooleanConstantOperation(True))

    def is_false(self) -> Operation:
        return ComparisonOperation(self,ComparisonOperator.EQUAL, BooleanConstantOperation(False))
...
class IntegerAttribute(NumericAttribute):
    ...
    def eq(self, value: int) -> Operation:
        return ComparisonOperation(self,ComparisonOperator.EQUAL, IntegerConstantOperation(value))

    def __eq__(self, value: int) -> Operation:
        return ComparisonOperation(self,ComparisonOperator.EQUAL, IntegerConstantOperation(value))

    def __gt__(self, value: int) -> Operation:
        return ComparisonOperation(self,ComparisonOperator.GREATER_THAN, IntegerConstantOperation(value))

    def __lt__(self, value: int):
        return ComparisonOperation(self,ComparisonOperator.LESS_THAN, IntegerConstantOperation(value))

    def __ge__(self, value: int) -> Operation:
        return ComparisonOperation(self,ComparisonOperator.GREATER_THAN_OR_EQUAL_TO,
                                   IntegerConstantOperation(value))

    def __le__(self, value: int):
        return ComparisonOperation(self,ComparisonOperator.LESS_THAN_OR_EQUAL_TO,
                                   IntegerConstantOperation(value))
...
class DateAttribute(Attribute):
    ...
    def eq(self, value: datetime.date) -> Operation:
        return ComparisonOperation(self,ComparisonOperator.EQUAL, DateConstantOperation(value))

    def __eq__(self, value: datetime.date) -> Operation:
        return ComparisonOperation(self,ComparisonOperator.EQUAL, DateConstantOperation(value))

    def __gt__(self, value: datetime.date) -> Operation:
        return ComparisonOperation(self,ComparisonOperator.GREATER_THAN, DateConstantOperation(value))

    def __lt__(self, value: datetime.date):
        return ComparisonOperation(self,ComparisonOperator.LESS_THAN, DateConstantOperation(value))
...
class DateTimeAttribute(Attribute):
    ...
    def eq(self, value: datetime.datetime) -> Operation:
        return ComparisonOperation(self,ComparisonOperator.EQUAL, DateTimeConstantOperation(value))

    def __eq__(self, value: datetime.datetime) -> Operation:
        return ComparisonOperation(self,ComparisonOperator.EQUAL, DateTimeConstantOperation(value))

    def __gt__(self, value: datetime.datetime) -> Operation:
        return ComparisonOperation(self,ComparisonOperator.GREATER_THAN, DateTimeConstantOperation(value))

    def __lt__(self, value: datetime.datetime):
        return ComparisonOperation(self,ComparisonOperator.LESS_THAN, DateTimeConstantOperation(value))
