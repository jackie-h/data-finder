...
from datafinder_iceberg.iceberg_reader import read_repository_from_iceberg
...
class TestIcebergReader:
    ...
    def test_fail_on_error_true_raises(self, MockCatalog):
        ...
        with pytest.raises(Exception, match="Not an Iceberg table"):
            read_repository_from_iceberg("https://catalog.example.com", fail_on_error=True)
    ...
    def test_fail_on_error_false_skips_table(self, MockCatalog):
        ...
        repo = read_repository_from_iceberg("https://catalog.example.com", fail_on_error=False)
    ...
    def test_fail_on_error_false_logs_warning(self, MockCatalog, caplog):
        ...
        with caplog.at_level(logging.WARNING, logger="datafinder_iceberg.iceberg_reader"):
            read_repository_from_iceberg("https://catalog.example.com", fail_on_error=False)
    ...
    def test_fail_on_error_defaults_to_true(self, MockCatalog):
        ...
        with pytest.raises(Exception):
            read_repository_from_iceberg("https://catalog.example.com")
